...
/**
 * Clase ChallengeDeleteRequest
 *
 * Esta clase se utiliza para validar los datos de la solicitud cuando se intenta eliminar un challenge.
 * Extiende `FormRequest` de Laravel, lo que permite aplicar reglas de validación específicas y definir
 * mensajes de error personalizados.
 */
class ChallengeDeleteRequest extends FormRequest
{
    /**
     ...
     * un challenge en la base de datos.
     *

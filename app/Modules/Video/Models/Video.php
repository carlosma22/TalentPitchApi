 ...
 * Clase Video
 *
 * Representa un Video en la aplicación y maneja la autenticación, 
...
class Video extends Authenticatable
{
     ...
     *
     * Esta relación indica que un Video puede tener muchos desafíos (Videos).
     * Permite acceder a los desafíos asociados a un Video a través de esta relación.
     * 

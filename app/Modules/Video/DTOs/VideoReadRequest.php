...
/**
 * Clase VideoReadRequest
 *
 * Esta clase se utiliza para validar los datos de la solicitud cuando se intenta leer (listar) videos.
 * Extiende `FormRequest` de Laravel, lo que permite aplicar reglas de validación específicas y definir
 * mensajes de error personalizados.
 */
class VideoReadRequest extends FormRequest
{
    /**
     ...
     * Estas reglas aseguran que el número de página proporcionado sea válido antes de intentar obtener la lista de videos.
     *
